...
cd $TMPDIR
cp ./*.png $PBS_O_WORKDIR/sel-asr-inf-sweep1
cp ./*asr-on-table-entry.npz $PBS_O_WORKDIR/sel-asr-inf-sweep1
cp ./inf-asrna.npz $PBS_O_WORKDIR/sel-asr-inf-sweep1
