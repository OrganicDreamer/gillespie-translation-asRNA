...
for i in range(num_as_on_rates):
    ...
    if i == 0:
        ...
        results_entry = np.load('inf-asrna.npz')
...
plt.tight_layout()
plt.savefig(
'inf-final1.png')  # save the figure to file
...
plt.tight_layout()
plt.savefig(
'inf-final2.png')  # save the figure to file
plt.close()  # close the figure
...
plt.tight_layout()
plt.savefig(
'inf-final3.png')  # save the figure to file
plt.close()  # close the figure
...
plt.tight_layout()
plt.savefig(
'inf-final4.png')  # save the figure to file
plt.close()  # close the figure
...
plt.tight_layout()
plt.savefig(
'inf-final5.png')  # save the figure to file
plt.close()  # close the figure